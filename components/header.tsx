...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              {navItems.map((item) => {
                if (item.hasDropdown) {
                  ...
                  let timeoutRef: React.MutableRefObject<NodeJS.Timeout | null> = servicesTimeoutRef

                  if (item.label === "Services") {
                    dropdownItems = services
                    isOpen = isServicesDropdownOpen
                    setIsOpen = setIsServicesDropdownOpen
                    timeoutRef = servicesTimeoutRef
                    ...
                    timeoutRef = industriesTimeoutRef
                    ...
                    timeoutRef = portfolioTimeoutRef
                  }
            ...
            <div className="hidden lg:flex items-center gap-3">
              <Button onClick={() => setIsBookingPopupOpen(true)}>
                Book a call
              </Button>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-background border-t border-border">
            <nav className="container mx-auto px-4 py-4 flex flex-col gap-4">
              ...
              <Button className="mt-2" onClick={() => { setIsMobileMenuOpen(false); setIsBookingPopupOpen(true); }}>
                Book a call
              </Button>
            </nav>
          </div>
      ...
      {/* Booking Popup - Rendered outside header for proper positioning */}
